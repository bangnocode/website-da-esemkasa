...
<head>
    ...
    <style>
        /* Chart container agar tinggi fleksibel */
        #chartWrapper {
            position: relative;
            height: 400px;
            width: 100%;
...
<body class="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-5xl w-full bg-white shadow-xl rounded-3xl p-6 sm:p-8 border border-slate-200">
        <!-- Header -->
        <div class="text-center mb-8">
            ...
            <p class="text-base sm:text-lg text-slate-600">
                Dewan Ambalan SMK Negeri 1 Banyuwangi
            </p>
        </div>

        <!-- Ringkasan -->
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl p-5 border border-blue-200/50 text-center">
                <p class="text-sm font-semibold text-blue-600 uppercase tracking-wide">Total Suara Masuk</p>
                <p class="text-3xl sm:text-4xl font-bold text-blue-900 mt-1" id="totalVotes">0</p>
            </div>
            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-xl p-5 border border-emerald-200/50 text-center">
                <p class="text-sm font-semibold text-emerald-600 uppercase tracking-wide">Partisipasi</p>
                <p class="text-3xl sm:text-4xl font-bold text-emerald-900 mt-1" id="partisipasi">0%</p>
        ...
        <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
            @foreach ($labels as $i => $label)
                <div class="flex flex-col justify-between bg-slate-50 rounded-xl px-5 py-4 border shadow-sm">
                    <span class="font-semibold text-slate-800 text-base sm:text-lg">{{ $label }}</span>
                    <span class="text-slate-700 font-medium mt-2 text-sm sm:text-base">
