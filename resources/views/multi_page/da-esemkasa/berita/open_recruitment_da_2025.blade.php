...
<body class="overflow-x-hidden scroll-smooth bg-slate-50 text-gray-800">
    ...
    <section class="mt-32 mb-20 px-4 md:px-8">
        ...
        <!-- Judul -->
        <h1 class="text-2xl md:text-3xl font-bold text-center text-sky-900 leading-snug mb-6">
            Open Recruitment Anggota Dewan Ambalan Tahun 2025
        </h1>

        <!-- Gambar -->
        <div class="max-w-4xl mx-auto mb-6">
            <img src="{{ asset('img/da-esemkasa/galeri/IMG_1659_6_11zon.webp') }}" alt="Open Recruitment 2025"
                class="rounded-lg w-full h-64 md:h-96 object-cover shadow-lg">
        </div>
